...
@section('custom_scripts')
    <!-- Apex Chart -->
    <script type="text/javascript" src="{{URL::asset('assets/js/plugins/apexcharts.min.js')}}"></script>

    <!-- custom-chart js -->
    <script type="text/javascript" src="{{URL::asset('assets/js/pages/dashboard-main.js')}}"></script>
